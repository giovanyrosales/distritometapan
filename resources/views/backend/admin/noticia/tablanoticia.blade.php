                        ...
                        <table id="tabla" class="table table-bordered table-striped">
                            ...
                            @foreach($listado as $dato)
                                <tr>
                                    ...
                                    <td style="width: 5%">{{ $dato->nombrenoticia }}</td>
                                    ...
                                    <td style="width: 4%">
                                        ...
                                        <button type="button" class="btn btn-primary btn-xs" onclick="vistaImagenes({{ $dato->id }})">
                                            <i class="fas fa-image" title="Imagenes"></i>&nbsp; Imagenes
                                        </button>
