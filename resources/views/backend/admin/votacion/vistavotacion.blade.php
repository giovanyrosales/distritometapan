                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input style="color:#191818" type="text" id="descripcion-nuevo" class="form-control" maxlength="300" />
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label>Descripción</label>
                                        <input style="color:#191818" type="text" id="descripcion-editar" class="form-control" maxlength="300" />
                                    </div>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var ruta = "{{ URL::to('/admin/votacion/tabla') }}";
    ...
    <script>
        ...
        function nuevoRegistro(){
            ...
            axios.post('/admin/votacion/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id){
            ...
            axios.post('/admin/votacion/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editarRegistro(){
            ...
            axios.post('/admin/votacion/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function modalBorrar(id){
            Swal.fire({
                title: 'Borrar?',
                text: "Esto Eliminara todas sus votaciones",
                icon: 'info',
        ...
        function solicitarBorrar(idfila){
            ...
            axios.post('/admin/votacion/borrar',{
                'id': idfila
            })
                .then((response) => {
                    closeLoading();
