        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">{{ $infoDistrito->nombre }}</li>
        ...
        <div class="container-fluid">
            <div class="card card-gray-dark">
                <div class="card-header">
                    <h3 class="card-title">Listado de Distrito - Servicios</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label>Nombre</label>
                                        <input style="color:#191818" autocomplete="off" type="text" id="nombre-editar" class="form-control" maxlength="100" />
                                    </div>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var id = {{ $id }};
            var ruta = "{{ URL::to('/admin/distritos/servicios/tabla') }}/" + id;
    ...
    <script>
        ...
        function nuevoRegistro(){
            ...
            axios.post('/admin/distritos/servicios/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id){
            ...
            axios.post('/admin/distritos/servicios/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editarRegistro(){
            ...
            axios.post('/admin/distritos/servicios/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
