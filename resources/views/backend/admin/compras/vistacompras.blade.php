                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label>Título</label>
                                        <input style="color:#191818" type="text" id="titulo-nuevo" class="form-control" maxlength="150" />
                                    </div>

                                    <div class="form-group">
                                        <label>Descripción</label>
                                        <input style="color:#191818" type="text" id="descripcion-nuevo" class="form-control" maxlength="1500" />
                                    </div>

                                    <div class="form-group">
                                        <label>Documento</label>
                                        <div class="col-md-10">
                                            <input type="file" style="color:#191818" id="documento-nuevo" accept="image/jpeg, image/jpg, image/png" />
                                        </div>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label>Título</label>
                                        <input style="color:#191818" type="text" id="titulo-editar" class="form-control" maxlength="150" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label>Documento</label>
                                        <div class="col-md-10">
                                            <input type="file" style="color:#191818" id="documento-editar" accept="image/jpeg, image/jpg, image/png" />
                                        </div>
                                    </div>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var ruta = "{{ URL::to('/admin/compras/tabla') }}";
    ...
    <script>
        ...
        function nuevoRegistro(){
            ...
            var documento = document.getElementById("documento-nuevo");
            ...
            if(documento.files && documento.files[0]){ // si trae imagen
                if (!documento.files[0].type.match('image/jpeg|image/jpeg|image/png')){
                    toastr.error('Formato permitido: .png .jpg .jpeg');
                    return;
                }
            }else{
            ...
            axios.post('/admin/compras/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id){
            ...
            axios.post('/admin/compras/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editarRegistro(){
            ...
            axios.post('/admin/compras/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
