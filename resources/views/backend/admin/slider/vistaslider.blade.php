                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input style="color:#191818" type="text" id="descripcion-nuevo" class="form-control" maxlength="100" />
                                    </div>

                                    <div class="form-group">
                                        <label>Link (Opcional)</label>
                                        <input style="color:#191818" type="text" id="link-nuevo" class="form-control" maxlength="500" />
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label>Descripción (Opcional)</label>
                                        <input style="color:#191818" type="text" id="descripcion-editar" class="form-control" maxlength="100" />
                                    </div>

                                    <div class="form-group">
                                        <label>Link (Opcional)</label>
                                        <input style="color:#191818" type="text" id="link-editar" class="form-control" maxlength="500" />
                                    </div>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var ruta = "{{ URL::to('/admin/slider/tabla') }}";
    ...
    <script>
            ...
            axios.post('/admin/slider/informacion',{
                ...
                .then((response) => {
                    ...
                    if(response.data.success === 1){
                        ...
                        $('#id-editar').val(id);
                        $('#descripcion-editar').val(response.data.info.nombreslider);
        ...
        function solicitarBorrar(idfila){
            ...
            axios.post('/admin/slider/borrar',{
                'id': idfila
            })
                .then((response) => {
                    closeLoading();
