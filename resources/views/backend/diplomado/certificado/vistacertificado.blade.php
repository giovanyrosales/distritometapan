...
@section('archivos-js')
    ...
    <script>
        ...
        function nuevoRegistro(){
            ...
            axios.post('/admin/diplomado/certificado/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id){
            ...
            axios.post('/admin/diplomado/certificado/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editarRegistro(){
            ...
            axios.post('/admin/diplomado/certificado/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
