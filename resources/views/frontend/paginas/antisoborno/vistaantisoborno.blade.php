                                ...
                                <div class="card" style="padding: 25px">
                                    ...
                                    <ul class="list-checked">
                                        <li>
                                            ...
                                            <a href="{{ asset('pdf/politicagestionv2.pdf') }}" target="_blank" style="font-weight:600; color:#0e7490;">
                                        ...
                                        <li>
                                            ...
                                            <a href="{{ asset('pdf/politicaregalov2.pdf') }}" target="_blank" style="font-weight:600; color:#0e7490;">
