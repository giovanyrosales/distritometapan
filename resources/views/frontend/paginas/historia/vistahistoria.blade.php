        ...
        <div class="container">
            <div class="row">
                <div class="about-flex animated zoomIn">
                    ...
                    <div class="col-three-forth text-justify" style="font-size: 15px;">
                        <h2>Historia</h2>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <img src="{{ asset('images/historia/metapanOld.jpg') }}" alt="" srcset="" class="img-responsive" width="370" height="310">
                                <br><br>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <img src="{{ asset('images/historia/trenOld.jpg') }}" alt="" srcset=""class="img-responsive" width="370" height="210">
